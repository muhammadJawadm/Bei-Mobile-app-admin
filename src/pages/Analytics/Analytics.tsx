            ...
            <div className="mb-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    <div className="bg-gradient-to-br from-indigo-500 to-indigo-600 rounded-lg p-6 text-white">
                        ...
                        <p className="text-indigo-100 text-md font-bold">Total Users</p>
                    </div>
                    <div className="bg-gradient-to-br from-green-500 to-green-600 rounded-lg p-6 text-white">
                        ...
                        <p className="text-green-100 text-md font-bold">Active Users</p>
                    </div>
                    ...
                    <div className="bg-gradient-to-br from-blue-500 to-blue-600 rounded-lg p-6 text-white">
                        ...
                        <p className="text-blue-100 text-md font-bold">Engagement Rate</p>
                    </div>
                    <div className="bg-gradient-to-br from-purple-500 to-purple-600 rounded-lg p-6 text-white">
                        <FaDumbbell className="text-3xl opacity-80 mb-2" />
                        <p className="text-3xl font-bold mb-1">{analyticsData.globalUsageStats.totalEducationalCompleted.toLocaleString()}</p>
                        <p className="text-purple-100 text-md font-bold">Education <span className='text-sm font-light pl-3'>Complete</span></p>
                        
                    </div>
                    <div className="bg-gradient-to-br from-purple-500 to-purple-600 rounded-lg p-6 text-white">
                        <FaDumbbell className="text-3xl opacity-80 mb-2" />
                        <p className="text-3xl font-bold mb-1">{analyticsData.globalUsageStats.totalMentalExercisesCompleted.toLocaleString()}</p>
                        <p className="text-purple-100 text-md font-bold">Mental Exercises Completed</p>
                    </div>
                    <div className="bg-gradient-to-br from-purple-500 to-purple-600 rounded-lg p-6 text-white">
                        <FaDumbbell className="text-3xl opacity-80 mb-2" />
                        <p className="text-3xl font-bold mb-1">{analyticsData.globalUsageStats.totalPhysicalExercisesCompleted.toLocaleString()}</p>
                        <p className="text-purple-100 text-md font-bold">Physical Exercises Completed</p>
                    </div>
                </div>
            </div>
              {/* Summary Insights */}
